...
// 속성(특성: 이름, 나이, 직업 등) & 매서드(동작: 걷다, 말하다, 먹다) 구성
...
let person1 = new Person("Hwany", 28, "Developer");
...
let person4 = new Person2("Hwany", 28, "Developer");
person4.greet();


// 3. 객체의 참조 타입
// 원시타입: 문자열, 숫자, 불리언, null, undefined, Symbol

// 참조 타입: 주로 객체를 포함한 나머지 데이터 타입
// 메모리에 직접 저장된 값을 참조하는 데이터 타입
// 객체, 배열, 함수 등

let computer1 = { named: "Samsung Book3"};
let computer2 = computer1;

computer2.named = "Samsung Book3 Ultra";
console.log(computer1.named);
